...
// الاستعلام لاسترجاع بيانات الجدول الثاني (الرسائل)
$stmt2 = $conn->query("SELECT * FROM chat");
        ...
        <div class="header">
            ...
            <div class="icons">
                <a href="../index.html" class="link">
                    <img src="../img/house-solid.svg" alt="" srcset="" width="50px" height="50px">
                </a>
...
<div class="form-container" style='margin-top:50px;'>
      <form class="form">
        <div class="form-group">
          <label for="email">توزيعة لينكس التي تستخدمها</label>
          <input type="text" id="email" name="t" required="">
        </div>
        <div class="form-group">
          <label for="textarea">هل لديك اسألة حول التوزيعة ؟</label>
          <textarea name="textarea" id="textarea"  cols="50" name="q">          </textarea>
        </div>
...
<?php 
    foreach ($stmt2 as $row) {
        echo '<div class="card">';
        echo '<div class="card-header">' . $row['t'] . '</div>';
        echo '<div class="card-body">' . $row['q'] . '</div>';
        echo '<br>';
        echo "<h1> الحلول المقترحة : </h1>  ";
        echo '<div class="card-body">'. "<p>" . $row['id'] . "</p>"  . '</div>';
        echo '</div>';
        echo '<div class="card-body"> <a href="val.php?id='. $row["id"] .'"> اقتراح حل </a> </div>';
